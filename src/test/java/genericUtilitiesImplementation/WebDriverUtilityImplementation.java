package genericUtilitiesImplementation;
...
public class WebDriverUtilityImplementation {
	...
	public class WebDriverUtility {
		...
		/**
		 * This method is used to wait till web Element is found
		 * 
		 * @param time
		 */
		...
		/**
		 * This method launches browser, maximize it, navigates to application and also
		 * provides implicit wait
		 * 
		 * @param browser
		 * @param url
		 * @param time
		...
		/**
		 * This method is used to right clickon an element
		 * 
		 * @param element
		 */
		...
		/**
		 * This methodis used to fetch the screenshot based on Base^4 format
		 * 
		 * @return
		 */
		...
		public void scrollTillElement(WebElement element) {
			...
			js.executeAsyncScript("arguments[0].scrollIntoVeiw(true)", element);
		}
