...
public class WebDriverUtility {
	...
	/**
	 * This method launches browser, maximize it, navigates to application and also provides implicit wait application
	 * @param Browser
	 * @param url
	 * @param time
	 * @return
	...
	public WebDriver openApplication(String Browser, String url, long time) {
		...
		waitTilElementFound(time);
		return driver;

	}

	private void waitTilElementFound(long time) {
